            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader hidden-xs">
                        <h3><i class="fa fa-home"></i> Manage Feedback </h3>
                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Add Feedback</h3>
                                    </div>
                                    <!-- Panel body -->
                                    ...
                                    <f:form id="registrationForm" action="insertFeedback" class="form-horizontal" method="post" modelAttribute="FeedbackVO" enctype="multipart/form-data">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">Rating</label>
                                                <div class="col-xs-5">
                                                    <f:input type="text" class="form-control" path="rating" placeholder="Out of 5" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">Feedback</label>
                                                <div class="col-xs-5">
                                                    <f:textarea type="text" class="form-control" path="feedback" placeholder="Give your genuine feedback"></f:textarea>
                                                </div>
                                            </div>
