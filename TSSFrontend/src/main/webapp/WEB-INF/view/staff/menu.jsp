                            ...
                            <div class="nano-content">
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <!-- <li>
                                        ...
                                        Submenu
                                        <ul class="collapse">
                                            <li><a href="viewReports"><i class="fa fa-caret-right"></i> View Reports </a></li>
                                        </ul>
                                    </li>
                                     -->
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="loadComplaint"><i class="fa fa-caret-right"></i> Add Complaint </a></li>
                                            <li><a href="viewReply"><i class="fa fa-caret-right"></i> View Reply </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="loadFeedback"><i class="fa fa-caret-right"></i> add Feedback </a></li>
                                            <li><a href="viewFeedback"><i class="fa fa-caret-right"></i> View Feedback </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            <li><a href="viewDetection"><i class="fa fa-caret-right"></i> View Detection </a></li>
