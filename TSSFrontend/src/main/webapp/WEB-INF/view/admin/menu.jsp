                            ...
                            <div class="nano-content">
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="loadArea"><i class="fa fa-caret-right"></i> Add Area </a></li>
                                            <li><a href="viewArea"><i class="fa fa-caret-right"></i> View Area </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="loadStaff"><i class="fa fa-caret-right"></i> Add Staff </a></li>
                                            <li><a href="viewStaff"><i class="fa fa-caret-right"></i> View Staff </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <!--Submenu-->
                                        <ul class="collapse">
                                            <li><a href="viewComplain"><i class="fa fa-caret-right"></i> View Complaint </a></li>
                                        </ul>
                                    </li>
