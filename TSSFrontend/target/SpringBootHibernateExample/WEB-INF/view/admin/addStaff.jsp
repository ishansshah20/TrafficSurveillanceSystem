                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <f:form id="registrationForm" class="form-horizontal" method="post" modelAttribute="StaffVO" action="insertStaff">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <f:input type="text" class="form-control" path="phoneNO" placeholder="Phone no" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <f:input type="email" class="form-control" path="loginVO.username" placeholder="Email" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <f:select class="form-control" path="areaVO.areaId">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-5">
                                                    <f:textarea  class="form-control" path="address"></f:textarea>
                                                </div>
                                            </div>
