...
<html lang="en">
    <head>
        ...
        <title> Complaint |Traffic Surveillance System</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader hidden-xs">
                        <h3><i class="fa fa-home"></i> Manage Complaint </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel">
                                    ...
                                    <f:form id="registrationForm" action="insertComplaint" class="form-horizontal" method="post" modelAttribute="ComplainVO" enctype="multipart/form-data">
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">Complain Subject</label>
                                                <div class="col-xs-5">
                                                    <f:input type="text" class="form-control" path="complainSubject" placeholder="First name" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">Complain Description</label>
                                                <div class="col-xs-5">
                                                    <f:input type="text" class="form-control" path="complainDescription" placeholder="First name" />
                                                </div>
                                            </div>
