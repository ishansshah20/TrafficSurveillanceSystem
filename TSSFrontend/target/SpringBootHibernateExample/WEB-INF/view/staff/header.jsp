                                ...
                                <div class="nano scrollable">
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a href="#" class="media">
                                                    <div class="media-left"> <img src="<%=request.getContextPath()%>/adminResources/images/av2.png" alt="Profile Picture" class="img-circle img-sm"> </div>
                                            ...
                                            <li>
                                                <a href="#" class="media">
                                                    <div class="media-left"> <img src="<%=request.getContextPath()%>/adminResources/images/av4.png" alt="Profile Picture" class="img-circle img-sm"> </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a href="#" class="media">
                                                    <div class="media-left"> <img src="<%=request.getContextPath()%>/adminResources/images/av3.png" alt="Profile Picture" class="img-circle img-sm"> </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a href="#" class="media">
                                                    <div class="media-left"> <img src="<%=request.getContextPath()%>/adminResources/images/av6.png" alt="Profile Picture" class="img-circle img-sm"> </div>
                                                    <div class="media-body">
                    ...
                    <ul class="nav navbar-top-links pull-right">
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="pull-right"> <img class="img-circle img-user media-object" src="<%=request.getContextPath()%>/adminResources/images/av1.png" alt="Profile Picture"> </span>
